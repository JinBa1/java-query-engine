...
public class Tuple {
     ...
     * @see CuckooDB used for writing tuples to output file.
     ...
     * @see com.github.jinba1.cuckoodb.operator.DuplicateEliminationOperator used by hash-based distinct, etc
