...
class TupleComparatorTest {
    ...
    void testSingleColumnAscending() {
        ...
        Tuple small = new Tuple(Arrays.asList(1, 10));
        Tuple medium = new Tuple(Arrays.asList(5, 20));
        Tuple large = new Tuple(Arrays.asList(10, 30));
    ...
    void testSingleColumnSortOrder() {
        ...
        Tuple t1 = new Tuple(Arrays.asList(3, 0));
        Tuple t2 = new Tuple(Arrays.asList(1, 0));
        Tuple t3 = new Tuple(Arrays.asList(2, 0));
    ...
    void testMultiColumnSort() {
        ...
        Tuple t1 = new Tuple(Arrays.asList(5, 30));
        Tuple t2 = new Tuple(Arrays.asList(5, 10));
        Tuple t3 = new Tuple(Arrays.asList(5, 20));

        List<Tuple> tuples = Arrays.asList(t1, t2, t3);
        tuples.sort(comparator);

        assertEquals(10, tuples.get(0).getAttribute(1), "Secondary: 10 first");
        assertEquals(20, tuples.get(1).getAttribute(1), "Secondary: 20 second");
        assertEquals(30, tuples.get(2).getAttribute(1), "Secondary: 30 third");
    }
    ...
    void testMultiColumnPrimaryBreaksTie() {
        ...
        Tuple t1 = new Tuple(Arrays.asList(1, 100));
        Tuple t2 = new Tuple(Arrays.asList(2, 1));
    ...
    void testEqualTuplesReturnZero() {
        ...
        Tuple t1 = new Tuple(Arrays.asList(7, 42, 99));
        Tuple t2 = new Tuple(Arrays.asList(7, 42, 99));
    ...
    void testEqualOnSortColumnsOnly() {
        ...
        Tuple t1 = new Tuple(Arrays.asList(5, 100));
        Tuple t2 = new Tuple(Arrays.asList(5, 999));
    ...
    void testDifferentTupleLengths() {
        ...
        Tuple shortTuple = new Tuple(Arrays.asList(3));
        Tuple longTuple = new Tuple(Arrays.asList(3, 10, 20, 30));
    ...
    void testDifferentTupleLengthsDifferentValues() {
        ...
        Tuple t1 = new Tuple(Arrays.asList(1, 5));
        Tuple t2 = new Tuple(Arrays.asList(1, 5, 99, 100));
    ...
    void testNegativeValues() {
        ...
        Tuple negative = new Tuple(Arrays.asList(-5));
        Tuple zero = new Tuple(Arrays.asList(0));
        Tuple positive = new Tuple(Arrays.asList(10));
    ...
    void testThreeColumnSort() {
        ...
        Tuple t1 = new Tuple(Arrays.asList(1, 2, 3));
        Tuple t2 = new Tuple(Arrays.asList(1, 2, 1));
        Tuple t3 = new Tuple(Arrays.asList(1, 1, 99));
        Tuple t4 = new Tuple(Arrays.asList(2, 0, 0));

        List<Tuple> tuples = Arrays.asList(t1, t2, t3, t4);
        tuples.sort(comparator);

        assertEquals(1, tuples.get(0).getAttribute(0));
        assertEquals(1, tuples.get(0).getAttribute(1));
        assertEquals(99, tuples.get(0).getAttribute(2));

        assertEquals(1, tuples.get(1).getAttribute(0));
        assertEquals(2, tuples.get(1).getAttribute(1));
        assertEquals(1, tuples.get(1).getAttribute(2));

        assertEquals(1, tuples.get(2).getAttribute(0));
        assertEquals(2, tuples.get(2).getAttribute(1));
        assertEquals(3, tuples.get(2).getAttribute(2));

        assertEquals(2, tuples.get(3).getAttribute(0));
        assertEquals(0, tuples.get(3).getAttribute(1));
        assertEquals(0, tuples.get(3).getAttribute(2));
    }
}
